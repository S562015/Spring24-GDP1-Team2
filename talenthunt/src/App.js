...
// Import the JobPostingPage component
import JobPostingPage from "./pages/jobpost/jobpost";
    ...
    <div className="App">
      ...
      <Routes>
        ...
        <Route element={<PrivateRoutesLayout auth={auth} />}>
          ...
          <Route
            path="/home"
            element={tabIdx === 0 ? <LandingPage /> : <EmployerHomePage />}
          />
